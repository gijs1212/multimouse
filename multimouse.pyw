...
class AutoSnapWindow(ctk.CTkToplevel, MiniMixin):
    ...
    def _open_settings(self):
        ...
        ctk.CTkCheckBox(win, text=tr("windows_startup"), variable=self.startup_enabled,
                        command=self._toggle_startup).pack(anchor="w", padx=20, pady=12)
        ctk.CTkButton(win, text=tr("full_calibration"), command=self._calibrate_from_settings).pack(fill="x", padx=20, pady=12)
